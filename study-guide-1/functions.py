...
def print_product(n1, n2):
    """Takes two integers and multiplies them together, and prints the result."""
...
def print_sign(n):
    """Takes an integer and prints "Higher than 0" if higher than zero and
    "Lower than 0" if lower than zero.    If the integer is zero, print "Zero"
    """

    if n == 0: print("Zero")
    elif n > 0: print("Higher than 0")
...
def is_divisible_by_three(n):
    """Takes an integer and returns a boolean, depending on whether the number is
    evenly divisible by 3.
    """
